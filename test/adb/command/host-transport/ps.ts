...
describe('psCommand', function () {
    ...
    it('should return a list of PsEntry', () => testPr(`UID             PID   PPID C STIME TTY          TIME CMD
...
`, [
    ...
    it('should return a list of PsEntry -A', () => testPr(`USER            PID   PPID     VSZ    RSS WCHAN            ADDR S NAME
